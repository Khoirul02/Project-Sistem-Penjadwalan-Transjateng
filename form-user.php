					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								?>
								<form class="form-horizontal" role="form" action="proses/user.php?action=<?php echo $action ?>&sp=<?php echo $sp ?>" method="post" enctype="multipart/form-data">
									<?php
									if($action == 'edit'){
									?>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="id_pengguna"> ID Pengguna </label>
											<div class="col-sm-9">
												<input type="text" id="id_pengguna" name="id_pengguna" placeholder="Kode" class="form-control" value="<?php echo $id_pengguna ?>" readonly />
											</div>
										</div>
									<?php
									}
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="kode_pengguna"> Kode Pengguna </label>

										<div class="col-sm-9">
											<input type="text" id="kode_pengguna" name="kode_pengguna" placeholder="Kode" class="form-control" value="<?php echo $kode_pengguna ?>" />
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="nama_lengkap_pengguna"> Nama Lengkap </label>

										<div class="col-sm-9">
											<input type="text" id="nama_lengkap_pengguna" name="nama_lengkap_pengguna" placeholder="Nama Lengkap" class="form-control" value="<?php echo $nama_lengkap_pengguna ?>"/>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="tempat_lahir_pengguna"> Tempat Lahir </label>
										...
										<div class="row">
											<div class="col-xs-8 col-sm-11">
												<div class="input-group">
													<input class="form-control date-picker" id="tanggal_lahir_pengguna" name="tanggal_lahir_pengguna" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $tanggal_lahir_pengguna ?>"/>
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="form-group">
												<div class="col-xs-12">
													<input multiple="" type="file" id="id-input-file-3" name="foto_pengguna" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="jabatan_pengguna"> Jabatan </label>
										<div class="col-sm-9">
											<input readonly="" type="text" class="form-control" id="jabatan_pengguna" name="jabatan_pengguna" value="<?php echo $value_jabatan;?>" />
										</div>
									</div>
